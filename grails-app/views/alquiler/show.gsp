...
<html>
    ...
    <body>
        ...
        <div id="show-alquiler" class="content scaffold-show" role="main">
            ...
            <f:display bean="alquiler" />
            <g:form resource="${this.alquiler}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.alquiler}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
