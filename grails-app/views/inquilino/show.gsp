...
<html>
    ...
    <body>
        ...
        <div id="show-inquilino" class="content scaffold-show" role="main">
            ...
            <f:display bean="inquilino" />
            <g:form resource="${this.inquilino}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.inquilino}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
